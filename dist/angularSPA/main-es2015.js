...
let UserService = UserService_1 = class UserService {
    ...
    updatefitnessdata(obj) {
        return this.http.put(UserService_1.BaseUrl + 'allfriends' + '/' + obj.id, obj, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => response.json()));
    }
    postcontactdata(obj) {
        return this.http.post(UserService_1.BaseUrl + 'contacts', obj, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => response.json()));
    }
};
...
module.exports = __webpack_require__(/*! D:\(Vikrant Dixit)angular-fsd-fitness-jest\src\main.ts */"./src/main.ts");
